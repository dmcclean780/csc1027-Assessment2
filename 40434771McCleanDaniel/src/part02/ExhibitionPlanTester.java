...
public class ExhibitionPlanTester {
    ...
    public static boolean testGetExhibitsInMonthWithInt() {
         ...
         */
        {
            ...
            int testMonth = 12;
            int[] expectedResult = {};
            String scenario = " id exceeding range";
         ...
         */
        {
            ...
            int testMonth = -1;
            int[] expectedResult = {};
            String scenario = "id below range";
    ...
    public static boolean testGetHallPlanString() {
         ...
         */
        {
            ...
            testRan += 10;
            String scenario = "-ve hall number";
         ...
         */
        {
            ...
            String expectedResult = "\tExhibit Hall 5\n";
            testRan += 10;
            String scenario = "exceeding max hall";
