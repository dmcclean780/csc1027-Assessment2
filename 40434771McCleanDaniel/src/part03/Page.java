...
public class Page {
    ...
    // Generic header and footer used on every page within the application
    // Gives the site a consistant appearance and more reusable code
    public Page(String title, String content, String footer, String previous){
        this.HTML  = "<HTML class = 'h-screen'><head><script src=\"https://cdn.tailwindcss.com\"></script><script src='http://localhost:9990/javascript/globalFunctions.js'></script></head><BODY class = 'h-full'>";
