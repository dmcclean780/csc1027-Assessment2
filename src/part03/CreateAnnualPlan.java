...
public class CreateAnnualPlan {
    ...
    public CreateAnnualPlan(ExhibitManagement exhibitManagement) {
        ...
        try {
            ...
            this.HTML += "<script src='http://localhost:9990/part03/createAnnualPlanFunctions.js'></script>";
            this.HTML += "<div class='flex flex-col justify-around w-2/3 max-h-full'>";
            ...
            this.HTML += "</div>";
            this.HTML += "<form class='flex flex-col justify-around h-full' action='create_annual_plan/create' method=\"POST\" enctype=\"multipart/form-data\">";
            this.HTML += "<input type=hidden id='hallNoInputHidden' name='hallNoInput' value='0'>";
            this.HTML += "<div id='planGrid' class='grid grid-rows-12 grid-cols-1 bg-gray-400 p-4 rounded-lg'>";
