...
public class Page {
    ...
    public Page(String title, String content, String footer, String previous){
        this.HTML  = "<HTML class = 'h-full'> <head><link href='https://unpkg.com/tailwindcss@^2.0/dist/tailwind.min.css' rel='stylesheet'><script src='http://localhost:9990/part03/jsFunctions.js'></script></head><BODY class = 'h-full'>";
