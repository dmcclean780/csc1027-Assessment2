...
public class ArtifactsList {
    ...
    public ArtifactsList(ArtifactManagement artifactManagement, String current) {
        ...
        this.HTML += "<INPUT  type='search' id='TypeInput' name='TypeInput' list='artifactYypes' class='rounded-md px-2'>";
        this.HTML += "</div>";

        this.HTML += "<div id='TimeInputDIV' style=\"display: none\">"; 
        this.HTML += "<LABEL for 'TimeInput' class='pr-4 font-bold'>Time:</LABEL>";
        this.HTML += "<INPUT  type='search' pattern= ^[1-9][0-9]*$ id='TimeInput' placeholder=\"integer greater than 0\" name='TimeInput' min='0' list='artifactTimes' class = 'rounded-md px-2'>";
        this.HTML += "</div>";
